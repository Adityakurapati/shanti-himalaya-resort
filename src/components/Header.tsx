...
const Header = () => {
        ...
        const isResortPage = location.pathname === "/our-resort" ||
                location.pathname === "/our-resort/how-to-reach" ||
                location.pathname === "/our-resort/set-menu-meals";
                        ...
                        <div className="container mx-auto px-4">
                                <div className="flex items-center justify-between h-20">
                                                                        ...
                                                                        <DropdownMenuContent className="w-64 bg-background border border-border shadow-lg">
                                                                                {topJourneys.map((journey) => (
                                                                                        <DropdownMenuItem key={journey.id} asChild>
                                                                                                <Link to={`/journeys/${journey.id}`} className="cursor-pointer">
                                                                                                        {journey.name}
                                                                                                </Link>
                                                                                        </DropdownMenuItem>
                                                                                ))}
                                                                                <DropdownMenuItem asChild>
                                                                                        <Link to="/journeys" className="cursor-pointer font-semibold text-primary">
                                                                                                View All Journeys
                                                                                        </Link>
                                                                                </DropdownMenuItem>
                                                                        </DropdownMenuContent>
                                                                        ...
                                                                        <DropdownMenuContent className="w-64 bg-background border border-border shadow-lg">
                                                                                {topDestinations.map((destination) => (
                                                                                        <DropdownMenuItem key={destination.id} asChild>
                                                                                                <Link to={`/destinations/${destination.id}`} className="cursor-pointer">
                                                                                                        {destination.name}
                                                                                                </Link>
                                                                                        </DropdownMenuItem>
                                                                                ))}
                                                                                <DropdownMenuItem asChild>
                                                                                        <Link to="/destinations" className="cursor-pointer font-semibold text-primary">
                                                                        ...
                                                                        <DropdownMenuContent className="w-64 bg-background border border-border shadow-lg">
                                                                                {topExperiences.map((experience) => (
                                                                                        <DropdownMenuItem key={experience.id} asChild>
                                                                                                <Link to={`/experiences/${experience.id}`} className="cursor-pointer">
                                                                                                        {experience.name}
                                                                                                </Link>
                                                                                        </DropdownMenuItem>
                                                                                ))}
                                                                                <DropdownMenuItem asChild>
                                                                                        <Link to="/experiences" className="cursor-pointer font-semibold text-primary">
                                        ...
                                        <div className="hidden lg:flex items-center space-x-4">
                                                ...
                                                <Link
                                                        to="/admin"
                                                        className="hidden md:flex items-center justify-center p-2 rounded-full border border-border hover:bg-muted transition-colors"
                                        ...
                                        <div className="md:hidden py-4 border-t border-border">
                                                <nav className="flex flex-col space-y-3">
                                                        ...
                                                        <div className="px-4 py-3 border-t border-border">
                                                                ...
                                                                <Button className="w-full hero-gradient">Book Now</Button>
                                                        </div>
                                                </nav>
                                        </div>
                                )}
