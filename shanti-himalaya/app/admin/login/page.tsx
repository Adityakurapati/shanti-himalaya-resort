...
const AdminLogin = () => {
        ...
        const handleLogin = async (e: React.FormEvent) => {
                ...
                try {
                        ...
                        // Prefer the most relevant row (approved first if multiple)
                        ...
                        // Debug: log what we actually received from the DB
                        console.log("[v0] AdminLogin roleRows:", roleRows, "roleErr:", roleErr)
                        ...
                        const roleData = Array.isArray(roleRows) ? roleRows[0] : null
                        ...
                        <Card className="w-full max-w-md">
                                ...
                                <CardContent>
                                        ...
                                        <div className="mt-4 text-center text-sm">
                                                ...
                                                <Button variant="link" className="p-0 h-auto" onClick={() => router.push("/admin/signup")}>
