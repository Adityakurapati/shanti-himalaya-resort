                                        ...
                                        >
                                                ...
                                                >
                                                        ...
                                                        <Button
                                                                size="lg"
                                                                variant="outline"
                                                                className="border-2 border-foreground/20 text-foreground hover:bg-foreground hover:text-background text-lg px-8 py-4 transition-all duration-300"
                                                        >
                                                                                                        ...
                                                                                                        <Card className="h-full bg-white/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                                                                                                                <CardContent className="p-6">
                                                                                                                        <div className="text-center mb-4">
                                                                                                                                ...
                                                                                                                                <h3 className="text-lg font-bold text-foreground mt-2">{details.season}</h3>
                                                                                                                        </div>
                                                                                                                        ...
                                                                                                                        <div className="space-y-3 text-sm">
                                                                                                                                {details.weather && (
                                                                                                                                        <div>
                                                                                                                                                ...
                                                                                                                                                <p className="text-muted-foreground">{details.weather}</p>
                                                                                                                                        </div>
                                                                                                                                )}
                                                                                                                                {details.why_visit && (
                                                                                                                                        <div>
                                                                                                                                                <p className="font-semibold text-foreground">Why Visit</p>
                                                                                                                                                <p className="text-muted-foreground">{details.why_visit}</p>
                                                                                                                                        </div>
                                                                                                                                )}
                                                                                                                                {details.events && (
                                                                                                                                        <div>
                                                                                                                                                <p className="font-semibold text-foreground">Events & Festivals</p>
                                                                                                                                                <p className="text-muted-foreground">{details.events}</p>
                                                                                                                                        </div>
                                                                                                                                )}
                                                                                                                        </div>
                                                                                                                </CardContent>
                                ...
                                <section className="py-20 hero-gradient text-white relative overflow-hidden">
                                        ...
                                        <div className="container mx-auto px-4 relative z-10">
                                                <div className="max-w-4xl mx-auto text-center">
                                                        ...
                                                        >
                                                                Let us craft your perfect journey with expert guidance and seamless planning.
                                                        </motion.p>
                                                        <motion.div
